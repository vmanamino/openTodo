...
RSpec.describe Api::ListsController, type: :controller do
  ...
  describe '#index' do
    ...
    context 'active key' do
      ...
      it_behaves_like 'index with active key'
  ...
  describe '#create' do
    ...
    context 'user with wrong key' do
      it_behaves_like 'create with wrong key', 'list', { name: 'my shared example list', permissions: 'viewable' }
      it_behaves_like 'create with the wrong key message', 'list', { name: 'my shared example list', permissions: 'viewable' }, 'you are not the owner of the requested list'
    end
  end
  describe '#update' do
    before do
