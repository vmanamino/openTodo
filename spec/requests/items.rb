...
RSpec.describe Api::ItemsController, type: :request do
  ...
  describe '#create request' do
    ...
    context 'user not authorized' do
      it_behaves_like 'wrong key', 'item', { :create => :post }, { item: { name: 'get it done' } }
      it_behaves_like 'wrong key with message', 'item', { :create => :post }, { item: { name: 'get it done' } }, 'you are not the list owner'
    end
  end
  describe '#update request' do
    ...
    context 'user not authorized' do
      it_behaves_like 'wrong key', 'item', { :update => :patch }, { item: { name: 'my finished item', done: true } }
      it_behaves_like 'wrong key with message', 'item', { :update => :patch }, { item: { name: 'my finished item', done: true } }, 'you are not the list owner'
    end
  end
end
